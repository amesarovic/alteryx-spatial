...
class BufferTool_05(MacroSpec):
    name: str = "BufferTool_05"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class BufferTool_05Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("BufferTool_05").addElement(
    ...
    def apply(self, props: BufferTool_05Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return BufferTool_05.BufferTool_05Properties(
