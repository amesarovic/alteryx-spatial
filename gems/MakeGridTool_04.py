...
class MakeGridTool_04(MacroSpec):
    name: str = "MakeGridTool_04"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class MakeGridTool_04Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        return Dialog("MakeGridTool_04").addElement(
    ...
    def apply(self, props: MakeGridTool_04Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return MakeGridTool_04.MakeGridTool_04Properties(
