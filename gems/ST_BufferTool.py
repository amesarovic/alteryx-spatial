...
class ST_BufferTool(MacroSpec):
    name: str = "ST_BufferTool"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class ST_BufferToolProperties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("ST_BufferTool").addElement(
    ...
    def apply(self, props: ST_BufferToolProperties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return ST_BufferTool.ST_BufferToolProperties(
