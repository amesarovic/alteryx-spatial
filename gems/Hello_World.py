...
class Hello_World(MacroSpec):
    ...
    class Hello_WorldProperties(MacroProperties):
    ...
    def apply(self, props: Hello_WorldProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return Hello_World.Hello_WorldProperties(
