...
class MakeGridTool_05(MacroSpec):
    name: str = "MakeGridTool_05"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class MakeGridTool_05Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        return Dialog("MakeGridTool_05").addElement(
    ...
    def apply(self, props: MakeGridTool_05Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return MakeGridTool_05.MakeGridTool_05Properties(
