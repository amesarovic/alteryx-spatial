...
class UC_BufferTool_02(MacroSpec):
    name: str = "UC_BufferTool_02"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class UC_BufferTool_02Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("UC_BufferTool_02").addElement(
    ...
    def apply(self, props: UC_BufferTool_02Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return UC_BufferTool_02.UC_BufferTool_02Properties(
