...
class DistanceOriginal(MacroSpec):
    name: str = "DistanceOriginal"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1

    @dataclass(frozen=True)
    class DistanceOriginalProperties(MacroProperties):
    ...
    def validate(self, context: SqlContext, component: Component) -> List[Diagnostic]:
        ...
        diagnostics = super(DistanceOriginal, self).validate(context, component)
    ...
    def apply(self, props: DistanceOriginalProperties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return DistanceOriginal.DistanceOriginalProperties(
