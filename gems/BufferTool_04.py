...
class BufferTool_04(MacroSpec):
    name: str = "BufferTool_04"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class BufferTool_04Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("BufferTool_04").addElement(
    ...
    def apply(self, props: BufferTool_04Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return BufferTool_04.BufferTool_04Properties(
