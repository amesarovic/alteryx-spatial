# commit: 46286e57ea6e309e8908f227469bb6b2281d88a4
...
class BufferTool_Old2(MacroSpec):
    name: str = "BufferTool_Old2"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class BufferTool_Old2Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        return Dialog("BufferTool_Old2").addElement(
    ...
    def apply(self, props: BufferTool_Old2Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return BufferTool_Old2.BufferTool_Old2Properties(
