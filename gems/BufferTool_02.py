...
class BufferTool_02(MacroSpec):
    name: str = "BufferTool_02"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class BufferTool_02Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        return Dialog("BufferTool_02").addElement(
    ...
    def apply(self, props: BufferTool_02Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return BufferTool_02.BufferTool_02Properties(
