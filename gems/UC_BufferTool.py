...
class UC_BufferTool(MacroSpec):
    name: str = "UC_BufferTool"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"


    @dataclass(frozen=True)
    class UC_BufferToolProperties(MacroProperties):
    ...
    def apply(self, props: UC_BufferToolProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return UC_BufferTool.UC_BufferToolProperties(
