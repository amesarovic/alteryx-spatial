...
class BufferTool_06(MacroSpec):
    name: str = "BufferTool_06"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class BufferTool_06Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("BufferTool_06").addElement(
    ...
    def apply(self, props: BufferTool_06Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return BufferTool_06.BufferTool_06Properties(
