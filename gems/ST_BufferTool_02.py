...
class ST_BufferTool_02(MacroSpec):
    name: str = "ST_BufferTool_02"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class ST_BufferTool_02Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("ST_BufferTool_02").addElement(
    ...
    def apply(self, props: ST_BufferTool_02Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return ST_BufferTool_02.ST_BufferTool_02Properties(
