...
class BufferTableTool(MacroSpec):
    name: str = "BufferTableTool"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class BufferTableToolProperties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("BufferTableTool").addElement(
    ...
    def apply(self, props: BufferTableToolProperties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return BufferTableTool.BufferTableToolProperties(
