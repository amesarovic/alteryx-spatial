...
class BufferTool_03(MacroSpec):
    name: str = "BufferTool_03"
    projectName: str = "andre_spatial_07"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class BufferTool_03Properties(MacroProperties):
    ...
    def apply(self, props: BufferTool_03Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return BufferTool_03.BufferTool_03Properties(
